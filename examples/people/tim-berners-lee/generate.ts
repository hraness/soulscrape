  ...
  relations: [
    {
      ...
      kind: "founded",
      target: "w3c",
      targetName: "World Wide Web Consortium",
    ...
    {
      id: "rel-web-foundation",
      kind: "founded",
      target: "world-wide-web-foundation",
      targetName: "World Wide Web Foundation",
      targetKind: "organization",
      note:
    ...
    },
    {
      id: "rel-odi",
      kind: "founded",
      target: "open-data-institute",
      targetName: "Open Data Institute",
      targetKind: "organization",
      note:
    ...
    },
    {
      id: "rel-plessey",
      kind: "employed_by",
      target: "plessey-telecommunications",
    ...
    {
      id: "rel-image-computer-systems",
      kind: "employed_by",
      target: "image-computer-systems",
    ...
    {
      id: "rel-robert-cailliau",
      kind: "collaborated",
      target: "robert-cailliau",
