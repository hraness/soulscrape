...
const packet = {
  ...
  relations: [
    {
      id: "rel-rephlex-records",
      kind: "founded",
      target: "rephlex-records",
      targetName: "Rephlex Records",
    ...
    {
      id: "rel-grant-wilson-claridge",
      kind: "cofounder",
      target: "grant-wilson-claridge",
      targetName: "Grant Wilson-Claridge",
      note: "His Rephlex Records co-founder — the DJ who suggested pressing records after hearing James's own tapes at Cornish clubs.",
      sourceIds: [S.rephlexWiki, S.sawWiki],
    },
    {
      id: "rel-warp-records",
    ...
    {
      id: "rel-chris-cunningham",
      kind: "collaborated",
      target: "chris-cunningham",
    ...
    {
      id: "rel-tom-middleton",
      kind: "collaborated",
      target: "tom-middleton",
      targetName: "Tom Middleton",
      note: "DJed alongside him at the Bowgie Inn in Crantock during the Cornwall years.",
      sourceIds: [S.sawWiki, S.rephlexWiki],
    },
    {
      id: "rel-philip-sherburne",
      kind: "interviewed_by",
