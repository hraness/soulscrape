...
const packet = {
  ...
  timeline: [
    ...
    },
    {
      ...
      organizationHandle: "talking-heads",
    ...
    },
    {
      ...
      organizationHandle: "rock-and-roll-hall-of-fame",
      sourceIds: [S.rockhall, S.rsFerry],
    },
    {
      ...
      organizationHandle: "earthpercent",
      sourceIds: [S.mixmagEarth, S.wired22],
    },
    {
    ...
    },
    {
      ...
      organizationHandle: "sundance-film-festival",
  ...
  relations: [
    ...
    },
    {
      ...
      kind: "member_of",
      target: "roxy-music",
      targetName: "Roxy Music",
      targetKind: "organization",
      start: "1971",
      end: "1973",
      targetWikidataId: "Q334648",
      note: "Synthesizer and tape-effects player on the first two albums and early tours; inducted with the band into the Rock & Roll Hall of Fame in 2019.",
      sourceIds: [S.rockhall, S.rsFerry, S.enowebKeyboard, S.wikiEno],
    },
    {
      id: "rel-robert-fripp",
      kind: "collaborated",
      target: "robert-fripp",
      targetName: "Robert Fripp",
      start: "1973",
      note: "The (No Pussyfooting) tape-loop sessions and Evening Star — the partnership that became 'Frippertronics'.",
      sourceIds: [S.enowebKeyboard, S.wikiEno],
    },
    {
      id: "rel-david-bowie",
      ...
      targetWikidataId: "Q5383",
      note: "The 'Berlin trilogy' — Low, 'Heroes', Lodger. His precise credit varies between sources (collaborator, co-writer, co-producer; Tony Visconti produced).",
      sourceIds: [S.guardianMorley, S.wikiEno],
    },
    {
      id: "rel-talking-heads",
      kind: "collaborated",
      target: "talking-heads",
      targetName: "Talking Heads",
      targetKind: "organization",
      start: "1978",
      end: "1980",
      targetWikidataId: "Q205001",
      note: "Produced three consecutive albums — More Songs About Buildings and Food, Fear of Music, and Remain in Light.",
      sourceIds: [S.rsRemain, S.enowebKeyboard],
    },
    {
      id: "rel-david-byrne",
      ...
      note: "Remain in Light co-writing plus the duo album My Life in the Bush of Ghosts (1981).",
      sourceIds: [S.rsRemain, S.wikiEno],
    },
    {
      id: "rel-daniel-lanois",
      kind: "collaborated",
      target: "daniel-lanois",
      targetName: "Daniel Lanois",
      start: "1983",
      targetWikidataId: "Q935369",
      note: "Apollo: Atmospheres and Soundtracks co-production, then the long U2 production partnership beginning with The Unforgettable Fire.",
      sourceIds: [S.pitchforkUF, S.mdtsLanois],
    },
    {
      id: "rel-u2",
      kind: "collaborated",
      ...
      targetKind: "organization",
      start: "1984",
      targetWikidataId: "Q396",
      note: "Co-produced with Lanois — The Unforgettable Fire and the run of albums that followed.",
      sourceIds: [S.pitchforkUF, S.mdtsLanois, S.guardianMorley],
    },
    {
      id: "rel-peter-schmidt",
      kind: "collaborated",
      target: "peter-schmidt",
      targetName: "Peter Schmidt",
      start: "1974",
      note: "Co-created the Oblique Strategies card deck, first published in 1975.",
      sourceIds: [S.vamOblique, S.wikiOblique],
    },
    {
      id: "rel-peter-chilvers",
      kind: "collaborated",
      target: "peter-chilvers",
      targetName: "Peter Chilvers",
      start: "2008",
      note: "The generative-music apps partnership — Bloom and its successors — plus album collaborations.",
      sourceIds: [S.genMusic, S.genMusicBloom],
    },
    {
      id: "rel-coldplay",
      ...
      targetKind: "organization",
      start: "2008",
      targetWikidataId: "Q45188",
      note: "Produced Viva la Vida or Death and All His Friends (2008).",
      sourceIds: [S.coldplayViva],
    },
    {
      id: "rel-beatie-wolfe",
      kind: "collaborated",
      target: "beatie-wolfe",
      targetName: "Beatie Wolfe",
      start: "2025",
      note: "The 2025 collaborative albums Luminal and Lateral.",
      sourceIds: [S.umcLuminal, S.wikiLateral],
    },
    {
      id: "rel-earthpercent",
      kind: "founded",
      target: "earthpercent",
      targetName: "EarthPercent",
      targetKind: "organization",
      start: "2021",
      note: "Co-founded the music-industry climate charity at its 2021 public launch; his role later shifted from trustee to patron.",
      sourceIds: [S.mixmagEarth, S.wired22],
    },
  ],
  openQuestions: [
