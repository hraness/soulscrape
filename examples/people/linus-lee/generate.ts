...
const packet = {
  ...
  relations: [
    {
      id: "rel-spensa-technologies",
      kind: "employed_by",
      target: "spensa-technologies",
      targetName: "Spensa Technologies",
    ...
    {
      id: "rel-thrive-capital",
      kind: "employed_by",
      target: "thrive-capital",
      targetName: "Thrive Capital",
      targetKind: "organization",
      note:
    ...
    {
      id: "rel-samarth-jajoo",
      kind: "collaborated",
      target: "samarth-jajoo",
