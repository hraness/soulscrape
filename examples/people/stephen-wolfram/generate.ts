...
const packet = {
  ...
  relations: [
    {
      id: "rel-wolfram-research",
      kind: "founded",
      target: "wolfram-research",
      targetName: "Wolfram Research",
    ...
    },
    {
      id: "rel-ccsr",
      kind: "founded",
      target: "center-for-complex-systems-research",
    ...
    {
      id: "rel-wolfram-media",
      kind: "founded",
      target: "wolfram-media",
      targetName: "Wolfram Media",
      targetKind: "organization",
      note: "His own imprint, which published A New Kind of Science on May 14, 2002.",
      sourceIds: [S.nksOnline, S.wiredLevy, S.about],
    },
    {
      id: "rel-caltech",
      ...
      targetName: "California Institute of Technology",
      targetKind: "organization",
      note:
