...
const packet = {
  ...
  relations: [
    {
      id: "rel-tufts-university",
      kind: "employed_by",
      target: "tufts-university",
      targetName: "Tufts University",
    ...
    {
      id: "rel-forsyth-institute",
      kind: "employed_by",
      target: "the-forsyth-institute",
      targetName: "The Forsyth Institute",
      targetKind: "organization",
      note:
    ...
    {
      id: "rel-harvard-university",
      kind: "employed_by",
      target: "harvard-university",
      targetName: "Harvard University",
      targetKind: "organization",
      note:
    ...
    {
      id: "rel-wyss-institute",
      kind: "member_of",
      target: "wyss-institute",
    ...
    },
    {
      id: "rel-icdo",
      kind: "member_of",
      target: "institute-for-computationally-designed-organisms",
      targetName: "Institute for Computationally Designed Organisms",
      targetKind: "organization",
      note: "Co-director, with Josh Bongard, of the institute behind the xenobots work.",
      sourceIds: [S.wyssBio, S.wikipedia, S.labSite],
    },
    {
      id: "rel-morphoceuticals",
      kind: "founded",
      target: "morphoceuticals",
      targetName: "Morphoceuticals, Inc.",
      targetKind: "organization",
      note:
        "Co-founded the company pursuing bioelectric control of organ growth — the 'morphoceuticals' program; it is listed among his lab affiliations.",
      sourceIds: [S.labSite, S.cellReview],
    },
    {
      id: "rel-tcrdb",
      kind: "founded",
      target: "tufts-center-for-regenerative-and-developmental-biology",
    ...
    {
      id: "rel-allen-frontiers",
      kind: "funded_by",
      target: "paul-g-allen-frontiers-group",
      targetName: "Paul G. Allen Frontiers Group",
      targetKind: "organization",
      note:
