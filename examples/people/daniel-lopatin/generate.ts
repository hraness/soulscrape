  ...
  relations: [
    {
      ...
      kind: "collaborated",
      target: "joel-ford",
      targetName: "Joel Ford",
      note: "Ford & Lopatin partner; together they launched the Software Recording Co. imprint under Mexican Summer in 2011.",
      sourceIds: [S.villageVoice, S.pfSoftware, S.mexicanSummer],
    },
    {
      id: "rel-tim-hecker",
      kind: "collaborated",
    ...
    },
    {
      ...
      kind: "collaborated",
      target: "nate-boyce",
      targetName: "Nate Boyce",
      note: "The Reliquary House audio-visual installation (2011) and a recurring visual collaborator.",
      sourceIds: [S.wikipedia, S.pfRplus7],
    },
    {
      id: "rel-anohni",
