...
const packet = {
  ...
  relations: [
    {
      id: "rel-qnx-software-systems",
      kind: "employed_by",
      target: "qnx-software-systems",
    ...
    },
    {
      ...
      note: "Oxide co-founder and CEO; frequent On the Metal co-host.",
      sourceIds: [S.obsDeckSoul, S.oxideBoot, S.infoq],
    },
    {
      id: "rel-jess-frazelle",
      kind: "cofounder",
    ...
    },
    {
      ...
      kind: "collaborated",
      target: "mike-shapiro",
      targetName: "Michael W. Shapiro",
      note: "DTrace co-designer and co-author of the 2004 USENIX paper; co-founded the Fishworks stealth group inside Sun.",
      sourceIds: [S.usenix04, S.wikipedia],
    },
    {
      id: "rel-adam-leventhal",
      kind: "collaborated",
      target: "adam-leventhal",
      targetName: "Adam Leventhal",
      note: "DTrace co-designer and co-author of the 2004 USENIX paper; Fishworks co-founder and frequent Oxide and Friends co-host.",
      sourceIds: [S.usenix04, S.wikipedia, S.obsDeckTalks],
    },
    {
      id: "rel-jeff-bonwick",
      kind: "collaborated",
    ...
    },
    {
      ...
      kind: "interviewed_by",
      target: "rashmi-mohan",
      targetName: "Rashmi Mohan",
      note: "ACM ByteCast episode 17 career interview, June 2021.",
      sourceIds: [S.bytecast],
    },
    {
      id: "rel-jeff-rothschild",
      kind: "interviewed",
    ...
    },
    {
      ...
      kind: "interviewed",
      target: "jon-masters",
      targetName: "Jon Masters",
      note: "On the Metal interview guest.",
      sourceIds: [S.oxidePodcast],
    },
    {
      id: "rel-john-graham-cumming",
      kind: "interviewed",
