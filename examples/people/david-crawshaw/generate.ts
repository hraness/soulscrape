...
const packet = {
  ...
  generatedAt: "2026-09-25T21:30:42Z",
  subject: {
    kind: "person",
  ...
  relations: [
    ...
    },
    {
      ...
      kind: "cofounder",
      target: "david-carney",
      targetName: "David Carney",
      note: "The third Tailscale co-founder, alongside Crawshaw and Avery Pennarun.",
      sourceIds: [S.kubelist, S.cybernews, S.betakit],
    },
    {
      id: "rel-exe-dev",
    ...
    {
      id: "rel-josh-bleecher-snyder",
      kind: "cofounder",
      target: "josh-bleecher-snyder",
      targetName: "Josh Bleecher-Snyder",
      note: "Co-founded the new company with him in late 2024 and built Sketch together; named exe.dev co-founder in Amplify's account.",
      sourceIds: [S.amplify, S.kubelist, S.principalAgent],
    },
    {
      id: "rel-ian-lance-taylor",
      kind: "collaborated",
    ...
    },
    {
      ...
      note: "Changelog Interviews #629, 'Programming with LLMs,' February 2025.",
      sourceIds: [S.changelog],
    },
    {
      id: "rel-jerod-santo",
    ...
    },
    {
      ...
      kind: "interviewed_by",
      target: "joe-ruscio",
      targetName: "Joe Ruscio",
      note: "High Leverage #11, 'Why Agents Need Computers,' June 2026.",
      sourceIds: [S.highLeverage],
    },
    {
      id: "rel-marc-campbell",
      kind: "interviewed_by",
      target: "marc-campbell",
      targetName: "Marc Campbell",
      note: "The Kubelist Podcast #54, 'The Age of Personalized Software,' July 2026.",
      sourceIds: [S.kubelist],
    },
    {
      id: "rel-benjie-de-groot",
      kind: "interviewed_by",
      target: "benjie-de-groot",
      targetName: "Benjie De Groot",
      note: "The Kubelist Podcast #54, 'The Age of Personalized Software,' July 2026.",
      sourceIds: [S.kubelist],
    },
  ],
